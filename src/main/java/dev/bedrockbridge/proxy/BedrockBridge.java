...
public class BedrockBridge {
     ...
     *
     * Beta6 API: BedrockPong uses a builder pattern — the old setter API was removed.
     */
    public BedrockPong buildPong(int onlinePlayers) {
        return BedrockPong.builder()
                .edition("MCPE")
                .motd(config.getLanMotd())
                .subMotd(config.getLanSubMotd())
